        ...
        <div className="w-full mt-2">
          ...
          <div className="flex justify-between items-center my-2 text-sm">
            <span className="text-[#A3A0DD] font-bold">
              {Category_name == "موبايلات" && isnew && <p> جديد</p>}
              {Category_name == "موبايلات" && !isnew & <p>قديم</p>}
              {Category_name == "عقارات" && <p>{real_estate_type}</p>}
              {Category_name == "سيارات" && for_sale && <p>للبيع</p>}
              {Category_name == "سيارات" && !for_sale && <p>للإيجار</p>}
            </span>
