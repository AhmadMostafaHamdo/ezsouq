...
const Main = () => {
  return (
    <div className="flex w-screen overflow-hidden  pt-24  md:pt-44 flex-col-reverse bg-primary pb-24 font-sans text-white md:h-[636px] md:flex-row md:px-20">
      ...
      <div className="container text-center flex w-screen justify-center flex-col items-center md:w-[50vw] md:pr-0 lg:pr-[4.7rem]">
        ...
        <Link
          to=""
          className="mt-8  block h-[8vh] w-[70vw] flex-center rounded-xl bg-white text-[1rem] font-bold text-primary md:h-[70px] md:w-[262px]"
        >
          نشر إعلان
        </Link>
      </div>
      ...
      <div className="flex w-full items-center justify-center md:justify-end">
        <div className="md:mt-0 ml-[-2rem] w-[70%] transform md:ml-20 md:-translate-x-[2rem]  translate-y-4 md:-translate-y-[20vh] scale-[1.4] md:scale-[2.2] lg:-translate-y-[.2rem] lg:translate-x-[0px] lg:scale-[1.4]">
